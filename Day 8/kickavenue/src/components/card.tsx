...
export function CardList() {
  ...
  const filtered = useMemo(() => {
    return products.filter((_) =>
      _.product_name.toLowerCase().includes(search.toLowerCase())
    );
  }, [products, search]);

  return (
    <div className="flex items-center flex-col max-w-screen-xl m-auto my-6">
      <div className="  text-center text-[20px] h-[58px] w-full">
